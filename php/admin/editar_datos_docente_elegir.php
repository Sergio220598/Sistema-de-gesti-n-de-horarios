...
?>
<div class="container" id="editar_docente" style="display: none;width:60%;border:2px solid #000;margin-top:20px">
     <h2>Editar datos del Docente</h2>
     <form class="form-horizontal" action="admin/editar_datos_docente.php" method="post">
