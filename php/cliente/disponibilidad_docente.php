...
?>
<div class="container" id="disponibilidad_docente" style="display: none; margin-left: 20px; padding-bottom: 20px;">
     <h2>Disponibilidad del Docente</h2>
     <form class="form-horizontal" action="cliente/sql_disponibilidad.php" method="post">
